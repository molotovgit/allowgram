...
#ifdef OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"Allowgram.Desktop.Store";
#else // OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"Allowgram.Desktop";
#endif // OS_WIN_STORE
...
void CleanupShortcut() {
	...
	QString path = systemShortcutPath() + u"Allowgram.lnk"_q;
...
bool checkInstalled(QString path = {}) {
	...
	const auto installed = u"Allowgram/Allowgram.lnk"_q;
	const auto old = u"Allowgram Legacy/Allowgram.lnk"_q;
